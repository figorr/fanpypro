...
# Directorio donde se guardan los archivos de códigos YAML
# Ruta: {config_dir}/custom_components/fanpypro_codes/
CODES_DIR = "fanpypro_codes"

# Valores por defecto para transmisión RF
